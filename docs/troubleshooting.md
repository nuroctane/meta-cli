...
Logs go to `~/.nur/nur.log` (not stderr). If you still see noise, check that you're on **v0.12.0+** and no wrapper is redirecting `RUST_LOG` to the console at `warn` for syntect.
